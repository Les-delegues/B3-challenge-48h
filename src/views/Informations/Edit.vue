<template>
  <div class="flex justify-between items-center">
    <h1 class="text-2xl font-bold py-4 text-blue-brand font-mina">
      Informations de l'association CCBA
    </h1>
  </div>
  ...
  <form method="POST" class="border border-gray-brand w-full rounded-lg shadow-md">
    ...
    <div class="flex items-center px-4 py-3">
      ...
      <input type="date" id="creationDate" v-model="associationInfos.creationDate" class="input" />
    </div>
  </form>
